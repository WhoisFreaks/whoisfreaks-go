...
// checks if the WhoisRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WhoisRole{}
...
func (o *WhoisRole) UnmarshalJSON(data []byte) (err error) {
	varWhoisRole := _WhoisRole{}

	err = json.Unmarshal(data, &varWhoisRole)

	if err != nil {
		return err
	}

	*o = WhoisRole(varWhoisRole)
...
func NewNullableWhoisRole(val *WhoisRole) *NullableWhoisRole {
	return &NullableWhoisRole{value: val, isSet: true}
}
