...
> BulkDomainAvailabilityResponse BulkDomainAvailabilityV2(ctx).BulkDomainAvailabilityRequest(bulkDomainAvailabilityRequest).Domain(domain).Format(format).Execute()
...
func main() {
	...
	resp, r, err := apiClient.DomainAvailabilityAPI.BulkDomainAvailabilityV2(context.Background()).BulkDomainAvailabilityRequest(bulkDomainAvailabilityRequest).Domain(domain).Format(format).Execute()
	if err != nil {
...
> DomainAvailabilityResponse DomainAvailabilityV2(ctx).Domain(domain).Sug(sug).Count(count).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DomainAvailabilityAPI.DomainAvailabilityV2(context.Background()).Domain(domain).Sug(sug).Count(count).Format(format).Execute()
	if err != nil {
