...
> WhoisHistoricalResponse WhoisHistory(ctx).ApiKey(apiKey).DomainName(domainName).Page(page).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WHOISAPI.WhoisHistory(context.Background()).ApiKey(apiKey).DomainName(domainName).Page(page).Format(format).Execute()
	if err != nil {
...
> ReverseWhoisResponse WhoisReverse(ctx).ApiKey(apiKey).Keyword(keyword).Page(page).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WHOISAPI.WhoisReverse(context.Background()).ApiKey(apiKey).Keyword(keyword).Page(page).Format(format).Execute()
	if err != nil {
